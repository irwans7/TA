...
//  pinMode(fadePin,OUTPUT);          // pin that will fade to your heartbeat!
 ...
 pinMode (I1,OUTPUT);
  ...
  LoadCell.start(5000); // load cells gets 2000ms of time to stabilize
  LoadCell.setCalFactor(11000); // calibration factor for load cell => strongly depende
